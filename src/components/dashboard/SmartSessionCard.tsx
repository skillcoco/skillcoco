...
export function SmartSessionCard({ dueCount, nextModuleName, estimatedMinutes }: SmartSessionCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl p-[2px]">
      {/* Gradient border */}
      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500" />

      {/* Card interior */}
      <div className="relative flex items-center justify-between gap-4 rounded-[10px] bg-[hsl(var(--card))] px-6 py-5">
        <div className="flex items-center gap-4">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-purple-500">
        ...
        <Link
          to="/review"
          className="inline-flex shrink-0 items-center gap-1.5 rounded-lg bg-gradient-to-r from-orange-500 to-purple-500 px-5 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90"
        >
          Start Session
          <ArrowRight size={16} />
        </Link>
