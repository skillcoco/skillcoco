...
// ── Phase 19.3 (D-01) — per-session CommandRecord history ──
//
// `CommandRecord`, `push_command_record`, and the two cap constants do not
// exist yet. These tests fail to COMPILE until Task 2 lands them — the
// compile failure is the correct RED signal (same convention as the Phase
// 19 EXAM-01 / Phase 19.3 Grain scaffolds in labs::spec).
#[cfg(test)]
