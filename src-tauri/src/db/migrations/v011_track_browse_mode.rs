...
mod tests {
    ...
    fn v011_idempotent_double_apply() {
        ...
        // schema_migrations has 15 rows after full apply.
        assert_eq!(count, 15, "exactly 15 rows in schema_migrations after idempotent double-apply (v012 + v013 + v014 + v015 added after v011)");
    }
}
