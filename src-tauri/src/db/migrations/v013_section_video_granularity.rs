...
mod tests {
    ...
    fn v013_current_version_is_13() {
        ...
        assert_eq!(version, 17, "current_version must be 17 after all migrations (through v017) are applied");
    }
    ...
    fn v013_idempotent_double_apply() {
        ...
        assert_eq!(
            count, 17,
            "exactly 17 rows in schema_migrations after idempotent double-apply"
        );
    }
