...
mod tests {
    ...
    fn v013_current_version_is_13() {
        ...
        assert_eq!(version, 15, "current_version must be 15 after all migrations (through v015) are applied");
    }
    ...
    fn v013_idempotent_double_apply() {
        ...
        assert_eq!(
            count, 15,
            "exactly 15 rows in schema_migrations after idempotent double-apply"
        );
    }
