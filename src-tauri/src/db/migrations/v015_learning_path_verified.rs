...
mod tests {
    ...
    fn v015_adds_verified_and_issuer_name_columns_and_version_is_15() {
        ...
        assert_eq!(version, 15, "current_version must be 15 after v015 is applied");
    ...
    fn v015_idempotent_double_apply() {
        ...
        let count: i32 = conn
            ...
            .unwrap();
        assert_eq!(count, 15, "exactly 15 rows in schema_migrations after idempotent double-apply (v015 learning_path_verified added)");
    }
}
