...
mod tests {
    ...
    fn v014_current_version_is_14() {
        ...
        assert_eq!(version, 17, "current_version must be 17 after v014..v017 are applied");
    }
    ...
    fn v014_idempotent_double_apply() {
        ...
        let count: i32 = conn
            ...
            .unwrap();
        assert_eq!(count, 17, "exactly 17 rows in schema_migrations after double-apply (v014..v017)");
    }
}
