...
maintainers of the Project, currently Gourav Shah / Initcron Systems
Private Limited (collectively, the "Maintainers").

## 1. Definitions

"Contribution" means any original work of authorship — including
source code, documentation, configuration, design, or any other
material — that you intentionally submit to the Project for
...
including pull requests, issues, comments, and discussions on the
Project's GitHub repository.

## 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, you hereby
grant to the Maintainers and to recipients of software distributed
by the Maintainers a perpetual, worldwide, non-exclusive, no-charge,
...
Project, or that your employer has signed a separate CLA with the
Maintainers.

(b) Each of your Contributions is your original creation, or that
...
OF ANY KIND, either express or implied, including any warranties or
conditions of TITLE, NON-INFRINGEMENT, MERCHANTABILITY, or FITNESS
FOR A PARTICULAR PURPOSE.

## 7. Notice of Changes

You agree to notify the Maintainers of any facts or circumstances
of which you become aware that would make these representations
inaccurate in any respect.

---

By signing the CLA Assistant comment on a pull request, you indicate
your acceptance of this Agreement and that you have read and
understood it. Signing is required once per contributor and applies
to all your future Contributions to the Project.
