...
//!
//! Populated at boot by [`super::loader`] and held in
...
//!
//! Phase 7 Wave 7 (07-07) — moved from `src-tauri/src/topic_packs/registry.rs`.

use std::collections::{BTreeMap, HashSet};

use super::model::{LoadedPack, PackSource};

/// In-memory registry of every loaded pack, keyed by canonical id.
...
mod tests {
    use super::*;
    use crate::packs::model::{Pack, ValidationStatus};
